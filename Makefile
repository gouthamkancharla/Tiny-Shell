...
test_all:
	echo ./sdriver.pl -t trace01.txt -s ./tsh -a \"-p\" > tsh.out
	./sdriver.pl -t trace01.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace02.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace02.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace03.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace03.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace04.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace04.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace05.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace05.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace06.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace06.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace07.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace07.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace08.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace08.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace09.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace09.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace10.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace10.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace11.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace11.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace12.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace12.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace13.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace13.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace14.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace14.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace15.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace15.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace16.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace16.txt -s ./tsh -a "-p" >> tsh.out
	echo ./sdriver.pl -t trace17.txt -s ./tsh -a \"-p\" >> tsh.out
	./sdriver.pl -t trace17.txt -s ./tsh -a "-p" >> tsh.out
